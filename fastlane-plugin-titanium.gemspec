...
require 'fastlane/plugin/titanium/version'

Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-titanium'
  spec.version       = Fastlane::Titanium::VERSION
  spec.author        = 'prop'
  ...
  spec.add_development_dependency('fastlane', '>= 2.88.0')
end
